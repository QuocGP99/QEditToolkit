...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                             QHBoxLayout, QLineEdit, QPushButton, QLabel, QFrame, QFileDialog, QTreeWidget, QTreeWidgetItem, QMessageBox, QSplitter, QMenu)
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.sidebar_container.setStyleSheet("background-color: #252525; border-right: 1px solid #333;")
        ...
        cat_label.setStyleSheet("color: #666; font-size: 11px; font-weight: bold; margin-top: 10px; margin-bottom: 5px;")
        ...
        import_btn.setStyleSheet("background-color: #007acc; color: white; border: none; padding: 6px 12px; border-radius: 4px; font-weight: bold;")
        ...
        self.status_label.setStyleSheet("background-color: #1e1e1e; color: #666; padding: 4px 10px; font-size: 11px;")
    ...
    def delete_folder(self, item):
        ...
        if confirm == QMessageBox.StandardButton.Yes:
            ...
            assets = [a for a in self.db.get_all_assets() 
            ...
            if os.path.exists(full_dir_path):
                try:
                    ...
                    QMessageBox.warning(self, "Error", f"Could not delete directory: {e}")
                    return
    ...
    def import_assets(self):
        ...
        if files:
            ...
            self.load_assets()
            self._populate_categories()
            QMessageBox.information(self, "Import Complete", f"Successfully imported {count} assets.")
