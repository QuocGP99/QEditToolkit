from PyQt6.QtWidgets import QListWidget, QListWidgetItem, QAbstractItemView, QMenu, QFileDialog, QMessageBox, QStyle
...
class AssetGrid(QListWidget):
    ...
    def show_context_menu(self, position):
        ...
        delete_selected_action = menu.addAction(f"Delete Selected ({len(self.selectedItems())})")
    ...
    def set_manual_preview(self, item):
        file_path, _ = QFileDialog.getOpenFileName(self, "Select Preview Image", "", "Images (*.png *.jpg *.jpeg)")
        if file_path:
            asset_id = item.data(Qt.ItemDataRole.UserRole + 1)
    ...
    def delete_asset(self, item):
        confirm = QMessageBox.question(self, "Delete Asset", 
    ...
    def delete_selected(self):
        ...
        confirm = QMessageBox.question(self, "Delete Selected Assets", 
